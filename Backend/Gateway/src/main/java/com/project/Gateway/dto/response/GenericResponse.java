package com.project.Gateway.dto.response;
...
public class GenericResponse<T> implements Serializable {
     ...
     */
    public GenericResponse(final HttpStatus httpStatus , final T data, final String successMessage, MessageSource messageSource, Object... args) {
     ...
     * @param args the message params
     */
    public GenericResponse(final HttpStatus httpStatus, final Map<String, String> errorDetails, String errorMessage, MessageSource messageSource,
                           Object... args) {
        this.httpStatus = httpStatus;
